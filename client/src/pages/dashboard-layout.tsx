...
import DashboardCreatorBotDetail from "./dashboard-creator-bot-detail";
import DashboardBotSettings from "./dashboard-bot-settings";
          ...
          <main className="flex-1 overflow-auto p-6">
            <div className="max-w-screen-2xl mx-auto">
              <Switch>
                ...
                <Route path="/dashboard/creator/bot/:id" component={DashboardCreatorBotDetail} />
